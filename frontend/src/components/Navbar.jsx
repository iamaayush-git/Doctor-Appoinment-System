...
const Navbar = () => {
  ...
  return (
    <div className='border-b h-20 mt-5 flex items-center justify-around'>
      ...
      {
        token ? <div className=' h-20 group relative flex flex-col justify-center gap-2'>
          ...
          <div className='group-hover:block hidden absolute -left-15 top-19 bg-stone-200 p-3 w-40 rounded-md space-y-2 '>
            ...
            <p onClick={() => setToken(false)} className='cursor-pointer hover:font-medium'>Logout</p>
          </div>
